...
<body bgcolor="#C6DDEE">
    <style type="text/css">
      A.header {color:black; text-decoration:none;}A.header:hover	{color:Blue;text-decoration:underline;font-weight:bold;}
    ...
    <script language="javascript" type="text/javascript">
    		...
    		function SetNode(nodename) {
    				...
    				// Open
	    			eval("image" + nodename + ".src = '<?php echo base_url();?>images/tree_image/utree_data/minus.gif'");
	...
	<div class="nodeheader">
        <b id="name1111" name="eMed"> </b>
        <span  onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image1111" onClick="SetNode('1111');" border="0">
        <span  id="nodeimage1111" onDblClick="SetNode('1111');">ERP</div>
	 <div class="nodedocuments" id="documents1111" style="display: block; margin-left: 16px;">
	
      <div class="nodeheader">
        <b id="name10" name="eMed"></b>
        <span  onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image10" onClick="SetNode('10');" border="0">
        <span  id="nodeimage10" onDblClick="SetNode('10');">HRM</div>
      <div class="nodedocuments" id="documents10" style="display: block; margin-left: 16px;">
        <?php if(!in_array($user_id,$usr_arr)){  ?>
        <?php if(!in_array($user_id,$usr_arr_2)){  ?>
          <div class="nodeheader">
              <b id="name12" name="Reception "></b>
              <span onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image12" onClick="SetNode('12');" border="0">
              <span  id="nodeimage12" onDblClick="SetNode('12');">Dash Board
          </div>
        <div class="nodedocuments" id="documents12" style="display: none; margin-left: 16px;">
          <div class="document">
        ...
        <?php } ?>
        <div class="nodeheader">
          <b id="name11" name="Reception "></b>
          <span onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image11" onClick="SetNode('11');" border="0">
          <span  id="nodeimage11" onDblClick="SetNode('11');">Employee Info </div>

        <div class="nodedocuments" id="documents11" style="display: none; margin-left: 16px;">
		   <div class="document">
        ...
        <?php if(!in_array($user_id,$usr_arr)){  ?>
        <div class="nodeheader">
          <b id="name32" name="OP Pharmacy"></b>
          <span onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image32" onClick="SetNode('32');">
          <span  id="nodeimage32" onDblClick="SetNode('32');">Setup</div>
        <div class="nodedocuments" id="documents32" style="display: none; Margin-left: 16;">
		 ...
		 <div class="nodeheader">
          <b id="name300" name="Entry System"></b>
          <span onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image300" onClick="SetNode('300');">
          <span  id="nodeimage300" onDblClick="SetNode('300');">Entry System</div>
      ...
      <?php
       ...
       <?php } ?>   
        ...
        <?php if(!in_array($user_id,$usr_arr_2)){  ?>
          ...
          <span onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image400" onClick="SetNode('400');">
          <span  id="nodeimage400" onDblClick="SetNode('400');">Process</div>
        <div class="nodedocuments" id="documents400" style="display: none; Margin-left: 16;">
          <div class="document">
     ...
     <!---process End -->
          ...
          <span onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image500" onClick="SetNode('500');">
          <span  id="nodeimage500" onDblClick="SetNode('500');">Reports</div>
        <div class="nodedocuments" id="documents500" style="display: none; Margin-left: 16;">
          <div class="document">
    ...
    <?php if(!in_array($user_id,$usr_arr)){  ?>
	  <div class="nodeheader">
        <b id="name9000" name="Payroll"> </b>
        <span  onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image9000" onClick="SetNode('9000');" border="0">
        <span  id="nodeimage9000" onDblClick="SetNode('9000');">Payroll</div>
	  <div class="nodedocuments" id="documents9000" style="display: block; margin-left: 16px;">
        <div class="nodeheader">
          <b id="name9001" name="Reception"></b>
          <span onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image9001" onClick="SetNode('9001');" border="0">
          <span  id="nodeimage9001" onDblClick="SetNode('9001');">Salary Process</div>
          ...
          <div class="document">
		    ...
		    <div class="nodeheader">
          <b id="name9002" name="Reports"> </b>
          <span onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image9002" onClick="SetNode('9002');">
          <span  id="nodeimage9002" onDblClick="SetNode('9002');">Reports</div>
        <div class="nodedocuments" id="documents9002" style="display: none; Margin-left: 16;">
		    <div class="document">
	 ...
	 <!--=============================================Maintenance============================================-->
	  <div class="nodeheader">
        <b id="name11000" name="Maintenance"></b>
        <span  onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image11000" onClick="SetNode('11000');" border="0">
        <span  id="nodeimage11000" onDblClick="SetNode('11000');">Maintenance</div>
	  <div class="nodedocuments" id="documents11000" style="display: block; margin-left: 16px;">
        <div class="nodeheader">
          <b id="name11001" name="Database "></b>
          <span onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image11001" onClick="SetNode('11001');" border="0">
          <span  id="nodeimage11001" onDblClick="SetNode('11001');">Database</div>  
		...
		<div class="nodeheader">
          ...
          <span onMouseOver="this.border='1';" onMouseOut="this.border='0';" id="image14001" onClick="SetNode('14001');" border="0">
          <span  id="nodeimage14001" onDblClick="SetNode('14001');">User</div>
