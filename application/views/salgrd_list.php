        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
              <div class="navbar-header">
                ...
                <a class="navbar-brand"href="<?=base_url('index.php/crud_con/salgrd_add')?>">Add Salary Grade</a>
              </div>
                      ...
                      <thead>
                        ...
                        <tbody>
                         ...
                         // print_r($pr_grade);exit('keno?');
                            ...
                            if(!empty($pr_grade)){ foreach($pr_grade as $pr_grades){?>

                                <tr>
                                    <td><?php echo $pr_grades['gr_name'] ?></td>
                                    <td><?php echo $pr_grades['gr_name_bn'] ?></td>


                                    <td >
                                        <a href="<?=base_url('index.php/crud_con/salgrd_edit').'/'.$pr_grades["gr_id"]?>"target='_blank' class="btn btn-primary" role="button">Edit</a>
                                    </td>

                                    <td>
                                        <a href="<?=base_url('index.php/crud_con/salgrd_delete').'/'.$pr_grades["gr_id"]?>" class="btn btn-danger" role="button">Delete</a>
