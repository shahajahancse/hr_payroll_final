...
<div class="content">
    ...
    <div class="col-md-8">
        ...
        <a class="btn btn-primary" href="<?= base_url() ?>index.php/entry_system_con/left_delete">Back</a>
            ...
            <div class="col-lg-6">
                <div class="input-group" style="display:flex; gap: 14px">
                    ...
                    <span class="input-group-btn">
                        <input class="btn btn-primary" onclick='add_left()' type="button" value='Add Left' />
                    </span>
                </div><!-- /input-group -->
            </div><!-- /.col-lg-6 -->
        </div><!-- /.row -->
...
<script>
  function add_left() {
    ...
    $.ajax({
      type: "POST",
      url: hostname + "entry_system_con/left_add_ajax",
      data: {
        sql: sql,
        date: date,
        unit_id: unit_id
      ...
      success: function(data) {
          $("#loader").hide();
          if (data == 'success') {
              showMessage('success', 'Left Added Successfully'); 
          }else {
              showMessage('error', 'Left Not Added');
          }
      }
    })
  }
