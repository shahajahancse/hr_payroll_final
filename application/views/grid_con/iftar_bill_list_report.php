        ...
        <table border="1" cellpadding="0" cellspacing="0" style="font-size:12px; width:1200px; margin-bottom:20px;">
			...
			<?php 
				...
				<tr>
					...
					<td style="text-align:left;   padding:2px"><?php echo $r->desig_name?></td>
					<td style="text-align:left;   padding:2px"><?php echo $r->ifter_day?></td>
					<td style="text-align:left;   padding:2px"><?php echo $r->ifter_amount?></td>
					<td style="text-align:left;   padding:2px"><?php echo $r->ifter_day*$r->ifter_amount?></td>
					<td></td>
				</tr>
			<?php } ?>
		</table>
