	...
	?>
					...
					<div style="width:100%; border-bottom:1px solid #000000; height:auto; overflow:hidden; line-height:11px;">
						<table width="300" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td width="75"><font style="font-family:'Times New Roman', Times, serif;font-size: 11px;">: <?php echo $rows->line_name_bn;   ?> </font></td>
							</tr>
							<tr>
						...
						<div style="float: left; width:240px; border-left:1px solid #000000; line-height:8px;" >
							<table width="236" style="font-size: 11px;">
								<tr>
									<td width="152"> বাস </td>
									<td >:</td>
									<td width="59" align="right"> <font style="font-family: SutonnyMJ; font-size:14px;"> <?php echo  $total_days = 0; //$total_days = $rows->transport_deduct;   ?> </font></td>
								</tr>
								<tr>
						...
						<table width="298" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="45" style="padding-right: 12px;" align="right">
									<span style="font-family: SutonnyMJ; font-size:14px;" > <?php echo $rows->ot_amount;?> </span>
								</td>
							</tr>
						</table>
					</div>
					...
					<div>
						<table width="295" height="17" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="78" style="padding-right: 9px;" align="right"> <font style="font-family: SutonnyMJ; font-size:14px;"> <?php echo $rows->gross_sal + $rows->ot_amount + $rows->att_bonus - $rows->total_deduct;?> </font></td>
		...
		<div style="width:100%; height:auto; ">
			...
			<div style="width:320px; height:auto; overflow:hidden; font-size:9px; font-family: SolaimanLipi;margin-bottom:50px; border:1px solid black;">
				...
				<div style="width:320px; margin-top:12px; line-height: 14px; height:auto; overflow:hidden; border:1px solid #000000;">
					<div style="width:100%; border-bottom:1px solid #000000; height:auto; overflow:hidden; line-height:11px;">
						<table width="300" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="76" style="font-size: 10px;">&#2472;&#2494;&#2478; </td>
						...
						<div style="float: left; width:240px; border-left:1px solid #000000; line-height:8px;" >
							<table width="236" style="font-size: 11px;">
								<tr>
									<td width="152"> বাস </td>
									<td >:</td>
									<td width="59" align="right"> <font style="font-family: SutonnyMJ; font-size:14px;"> <?php echo $total_days = 0; //$rows->transport_deduct;   ?> </font></td>
								</tr>
								<tr>
									<td width="152"> অগ্রীম </td>
									<td >:</td>
