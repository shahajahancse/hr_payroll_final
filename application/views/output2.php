...
<html>
  ...
  <body style="background-color:#FCE9D9;">
    <div class="container-fluid" style="padding-top: 10px;">
      ...
      <nav class="navbar navbar-inverse">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            //<a class="navbar-brand" href="<?=base_url('index.php/crud_con/company_add')?>" >Add Comapny Unit</a>
          </div>
      ...
      <div class="row">
          <div class="col-md-12">
              <div class="col-md-6"><h3 style="margin-top: 0px; margin-bottom: 8px;">Company Unit List</h3></div>
              <div class="col-md-6 text-right">
                  <a href="<?=base_url('index.php/crud_con/company_add')?>" class="btn btn-info" role="button">Add Company</a>
              </div>
         </div>
      </div>
