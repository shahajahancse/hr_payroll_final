            ...
            <table class="table" id="mytable">
                <thead>
                    <tr>
                        ...
                        <th>Unit name</th>
                        <th width="80">Edit</th>
                        <th <?php  $user_id = $this->session->userdata('data')->id; $acl = check_acl_list($user_id); if(in_array(140,$acl)) {echo '';} else { echo 'style="display:none;"';}?>>Delete</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                         if (!empty($attendance_bonus)) {foreach ($attendance_bonus as $key => $pr_lines) {?>
                            <tr>
                                ...
                                <td <?php if(in_array(140,$acl)) {echo '';} else { echo 'style="display:none;"';}?> >
