      ...
      <table class="table" id="mytable">
        <thead>
          <tr>
            ...
            <th>Division</th>
            <th width="80">Edit</th>
            <th <?php  $user_id = $this->session->userdata('data')->id; $acl = check_acl_list($user_id); if(in_array(147,$acl)) {echo '';} else { echo 'style="display:none;"';}?>>Delete</th>
          </tr>
        </thead>
        <tbody>
          <?php if(!empty($pr_dept)){ foreach($pr_dept as $pr_depts){?>
            <tr>
                ...
                <td <?php if(in_array(147,$acl)) {echo '';} else { echo 'style="display:none;"';}?> >
