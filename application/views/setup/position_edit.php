...
<div class="content">
    ...
    <div class="row tablebox">
        <div class="col-md-12">
          <h4 style="font-weight:bold">Update Position</h4>
        </div>
        <form action="<?php echo current_url() ?>" method="post">
            <div class="form-group col-md-4">
                ...
                <select name="unit_id" id="unit_id" class="form-control">
                    ...
                    ?>
                    <option <?= $value->unit_id == $attbn->unit_id? 'selected':'' ?> value="<?php echo $value->unit_id; ?>"><?php echo $value->unit_name; ?></option>
                    <?php } ?>
                </select>
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" name="posi_name" class="form-control" value="<?= $attbn->posi_name ?>" >
            </div>
            <div class="form-group col-md-4">
                <label>Position Name (Bangla)</label>
                <input type="text" name="posi_name_bn" class="form-control" value="<?= $attbn->posi_name_bn ?>">
            </div>
