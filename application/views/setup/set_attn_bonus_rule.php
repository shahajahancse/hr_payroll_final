...
<div class="content">
    ...
    <div class="col-md-8">
        ...
        <div id='loaader' style="display: none;align-items: center;justify-content: center;z-index: 33333;background: #e9e9e966;position: absolute;" class="col-md-12">
       		...
       		<form action="<?= base_url('setup_con/set_attn_bonus_rule')?>" enctype="multipart/form-data" method="post">
            <div class="row nav_head" style="display: flex;flex-direction: column;">
                ...
                <div class="col-md-12">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div class="col-md-6">
                            <label>Actual Bonus:</label><br>
                            <label class="radio-inline">
                                <input type="radio" name="attn_bonus_non_complaince" value="1" > Yes
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="attn_bonus_non_complaince" value="0"> No
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label>Complaince Bonus:</label><br>
                            <label class="radio-inline">
                                <input type="radio" name="attn_bonus_complaince" value="1"> Yes
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="attn_bonus_complaince" value="0"> No
                            </label>
                        </div>
                    </div>
                    <br>
