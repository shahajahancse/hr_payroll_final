      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <select name="district" id= "district" class="form-control input-sm" style="min-height: 35px !important; border: 1px solid #0aa699;">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <select name="upazila" id= "upazila" class="form-control input-sm" style="min-height: 35px !important; border: 1px solid #0aa699;">
