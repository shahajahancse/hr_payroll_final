<div class="content" style="padding-top: 10px;">
    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url('index.php/setup_con/weekend_allowance_setup')?>">Back To
                    List</a>
            </div>
    ...
    <hr>
    <form action="<?= base_url('index.php/setup_con/weekend_allowance_add')?>" enctype="multipart/form-data" method="post">
        <div class="row">
            <div class="col-md-6">
