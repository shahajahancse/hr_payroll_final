<div class="content" style="padding-top: 10px;">
    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url('setup_con/tiffin_bill')?>">Back To
                    List</a>
            </div>
    ...
    <hr>
    <form action="<?= base_url('setup_con/tiffin_bill_add')?>" enctype="multipart/form-data" method="post">
        <div class="row">
            <div class="col-md-6">
