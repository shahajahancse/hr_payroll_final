    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=base_url('index.php/setup_con/company_info_setup')?>">Back Comapny
                    Unit</a>
            </div>
             ...
             <div class="col-md-12">
                 ...
                 <div class="row">
                     <div class="form-group col-md-6" >
                         ...
                         <input style="padding: 4px 9px;height: 37px!important;border: 1px solid #0aa699 !important;" type="file" name="comlogo" id="comlogo" value=""
                             class="form-control">
                     </div>
                     <div class="form-group col-md-6">
                         <label>Company Signature</label>
                         <input style="padding: 4px 9px;height: 37px!important;border: 1px solid #0aa699 !important;" type="file" name="comsign" id="comsign" value=""
                             class="form-control">
                     </div>
                 </div>
                 <div class="row">
