<div class="content">
    ...
    <!-- <hr> -->
    <form action="<?= base_url('setup_con/roster_edit') . '/' . $pr_emp_roster_shift->id ?>" enctype="multipart/form-data"
        method="post">
        <?php
        // dd($pr_emp_roster_shift);
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="unit_id" id="unit_id" class="form-control select22" required>
                                ...
                                <option <?=$pr_emp_roster_shift->unit_id == $value->unit_id ? 'selected' : ''?>  value="<?php echo $value->unit_id; ?>"><?php echo $value->unit_name; ?></option>
                                <?php } ?>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="<?= $pr_emp_roster_shift->name ?>" id="name" class="form-control" placeholder="Name" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="duration"  value="<?= $pr_emp_roster_shift->duration ?>" id="duration" class="form-control" placeholder="Duration" required>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="start_date" value="<?= date('d-m-Y', strtotime($pr_emp_roster_shift->start_date)) ?>" value="<?= $pr_emp_roster_shift->start_date ?>" id="start_date" class="form-control date" placeholder="Start Date" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="end_date" value="<?= date('d-m-Y', strtotime($pr_emp_roster_shift->end_date)) ?>" id="end_date" class="form-control date" placeholder="End Date" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <select  name="shift_type[]" id="shift_type" class="select22 col-md-12" multiple="multiple">
                                ...
                                <?php
                                $pr_emp_roster_shift=json_decode($pr_emp_roster_shift->shift_type)[0];
                                foreach ($pr_emp_shift as $key => $value) { ?>
                                <option <?=in_array($value->id, $pr_emp_roster_shift) ? 'selected' : ''?>  value="<?php echo $value->id; ?>"><?php echo $value->shift_name; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
