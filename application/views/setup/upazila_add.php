  ...
  <div class="content">
    ...
    <div id="target-div">
      <div class="container-fluid">
        ...
        <h3><?= $title ?></h3>
        <hr>
        <form id="form" enctype="multipart/form-data" method="post" name="creatdepartment" action="<?php echo base_url('setup_con/upazila_add')?>">
          <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="upazila"value="" id="upazila" class="form-control" required>
              </div>
            </div>

            <div class="col-md-6  ">
              <div class="form-group">
                <label>Upazila / Thana (English)</label>
                <input type="text" name="upazila_en"value="" id="upazila_en" class="form-control" required>
                <?php echo form_error('upazila_en');?>
              </div>
            </div>
          </div>
          <div class="row">
 ...
 $('form[name="creatdepartment"]').submit(function (event) {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $('#upazila').val('');
        $('#upazila_en').val('');
        alert('Upazila added successfully');
      },
