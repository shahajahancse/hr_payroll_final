<div class="content" style="padding-top: 10px;">
    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Update Holyday/Weekend Allowance</a>
            </div>
    ...
    <h3>Update Holyday/Weekend Allowance</h3>
    <hr>
    <form action="<?= base_url('setup_con/weekend_allowance_edit').'/'.$attbn->id?> " enctype="multipart/form-data" method="post">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label>Rule</label>
                    <input type="text" name="rule" value="<?php echo $attbn->allowance_amount; ?>" placeholder="Amount" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <a href="<?php echo base_url('setup_con/attendance_bonus') ?>" class="btn-warning btn">Cancel</a>
                </div>
            </div>
        </div>
    </form>
