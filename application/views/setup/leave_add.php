<div class="content">
    ...
    <form action="<?= base_url('index.php/setup_con/leave_add')?>" enctype="multipart/form-data" method="post">
    <!-- <th>Leave Name</th>
                        <th>Sick Leave</th>
                        <th>Casual Leave</th>
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input required type="number" name="paternity_leave" value="" placeholder="Paternity Leave" class="form-control">
