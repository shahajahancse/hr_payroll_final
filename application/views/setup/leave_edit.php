            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <select name="unit_id" id="unit_id" class="form-control">
                            ...
                            ?>
                            <option value="<?php echo $value->unit_id; ?>" <?= ($value->unit_id == $pr_leave->unit_id) ? 'selected' : ''?>><?php echo $value->unit_name; ?></option>
                            <?php } ?>
                        </select>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input required type="text" name="leave_name" value="<?= $pr_leave->lv_name ?>" placeholder="Leave Name" class="form-control">
                ...
                <div class="row">
                    <div class="form-group col-md-3">
                        ...
                        <input required type="number" name="sick_leave" value="<?= $pr_leave->lv_sl ?>" placeholder="Sick Leave" class="form-control">
                        <?=(isset($failuer['sick_leave'])) ? '<div class="alert alert-failuer">' . $failuer['sick_leave'] . '</div>' : ''; ?>
                    </div>
                    <div class="form-group col-md-3">
                        <label>Casual Leave</label>
                        <input required type="number" name="casual_leave" value="<?= $pr_leave->lv_cl ?>" placeholder="Casual Leave" class="form-control">
                        <?=(isset($failuer['casual_leave'])) ? '<div class="alert alert-failuer">' . $failuer['casual_leave'] . '</div>' : ''; ?>
                    </div>
                    <div class="form-group col-md-3">
                        <label>Maternity Leave</label>
                        <input required type="number" name="maternity_leave" value="<?= $pr_leave->lv_ml ?>" placeholder="Maternity Leave" class="form-control">
