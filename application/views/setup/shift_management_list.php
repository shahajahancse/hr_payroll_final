...
<div class="content">
    ...
    <div class="row tablebox">
            <div class="col-md-6" style="margin-left:-16px">
                <h4 style="font-weight:bold">Shift Management List</h4>
            </div><hr>
        <!-- <div class="col-md-12"> -->
            <table class="table" id="mytable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?=base_url('index.php/setup_con/shiftmanagement_edit').'/'.$pr_emp_shifts["schedule_id"]?>"
                                class="btn btn-primary center-text input-sm" role="button">Edit</a>
                        </td>
                        <td>
                            <a href="<?=base_url('index.php/setup_con/shiftmanagement_delete').'/'.$pr_emp_shifts["schedule_id"]?>"
