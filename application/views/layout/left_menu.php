    ...
    <ul class="pull-left" style="margin-top: 5px">
      ...
      <li class="start <?= activate_class('setup_con') ?>"> <a href="javascript:;"> <i class="fa fa-cog"></i>
        ...
        <ul class="sub-menu ">
          ...
          <li class="start <?= activate_method('company_info_setup') ?>"> <a href="<?=base_url('setup_con/company_info_setup')?>" class="anchor_cls" id="company_info_menu">Company Information</a> </li>
